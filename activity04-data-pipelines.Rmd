...
**Response**: When message is TRUE, it includes a summary of which packages were attached and which had conflicts. This isnt really necessary for a knitted document, but is helpful when coding.
...
**Response**: Turning message on reveals some column specifications regarding the dataset.
...
**Response**: In SAS, I would sort the dataset by unemployment_rate in ascending order and the first observation would be the major with the lowest unemployment rate.
...
**Response**: This makes it much easier to see the rank, major, and unemployment rate without the distracting other columns.
...
**Response**: Early Childhood education has the highest percentage of women in any major. 
...
**Response**: There are several STEM Majors that have median salaries under 36,000. They all appear to have to do with the health and environment, although a few differ from this trend.
