...
**Response**: When message is TRUE, it includes a summary of which
packages were attached and which had conflicts. This isnt really
necessary for a knitted document, but is helpful when coding.
...
**Response**: Turning message on reveals some column specifications
...
**Response**: In SAS, I would sort the dataset by unemployment\_rate in
ascending order and the first observation would be the major with the
...
**Response**: This makes it much easier to see the rank, major, and
unemployment rate without the distracting other columns.
...
**Response**: Early Childhood education has the highest percentage of
women in any major.
